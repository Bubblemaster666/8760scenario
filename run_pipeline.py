...
def main():
    ...
    samples_with_metrics.to_csv(
        "samples_with_metrics.csv", index=False, encoding="utf-8-sig"
    )
    ...
    print(samples_evt)
    samples_evt.to_csv(
        "samples_evt_labeled.csv", index=False, encoding="utf-8-sig"
    )
    ...
    print(final_result)
    final_result.to_csv(
        "final_extreme_samples.csv", index=False, encoding="utf-8-sig"
    )
