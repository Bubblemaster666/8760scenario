...
class TrainConfig:
    ...
    out_dir: str = str(BASE_DIR / "mock_full_diffusion_evt_risk_outputs")
    seed: int = 42
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out-dir", type=str, default=str(BASE_DIR / "mock_full_diffusion_evt_risk_outputs"))
